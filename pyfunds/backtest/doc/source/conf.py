...
latex_documents = [
    (master_doc, "xalpha.tex", "xalpha Documentation", "refraction-ray", "manual"),
]
...
man_pages = [(master_doc, "xalpha", "xalpha Documentation", [author], 1)]
